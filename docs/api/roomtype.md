...
`HotelSearchService`), or physical room tracking (deferred — see [ADR-006](https://github.com/AhsanShafiqShawon/miniAgoda/blob/main/docs/architecture/decisions/ADR-006-defer-room-service.md)).
